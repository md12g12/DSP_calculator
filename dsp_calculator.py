...
def get_resources(component):
    """
    returns a list of tuples of the raw resources required by a component
    component = tuple of 2 items, name and quantity
    """
...
def get_components(component):
    """
    returns a list of tuples of the components required by a component
    component = tuple of 2 items, name and quantity
    """
...
def get_dependencies(dependencies, components=[], resources=[]):
    """
    returns a list of the total raw resources and components required by a components
    dependencies = list of lists containing the name and quantity e.g. [["item", 2],]
    components = [] empty list used to store recursive outputs as well as final output 
    resources = [], empty list used to store recursive outputs as well as final output
    """
...
if __name__ == "__main__":
    print(Counter(get_dependencies([["rocket", 1],],[],[])[1]))
